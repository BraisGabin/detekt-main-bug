        ...
        publications {
            create<MavenPublication>("release") {
                ...
                pom {
                    ...
                    url.set("https://github.com/braisgabin/detektmainbug/")
                    ...
                    scm {
                        connection.set("scm:git:git://github.com/braisgabin/detektmainbug.git")
                        developerConnection.set("scm:git:ssh://github.com/braisgabin/detektmainbug.git")
                        url.set("https://github.com/braisgabin/detektmainbug/")
                    }
                    issueManagement {
                        system.set("GitHub Issues")
                        url.set("https://github.com/braisgabin/detektmainbug/issues")
                    }
                }
            }
        }
